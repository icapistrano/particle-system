    ...
    <points ref={particleRef}>
      <bufferGeometry>
        <bufferAttribute
          ...
          count={particleCount}
        />
        <bufferAttribute attach={"attributes-alpha"} array={alphaRef.current} itemSize={1} count={particleCount} />
        <bufferAttribute attach={"attributes-scale"} array={scaleRef.current} itemSize={1} count={particleCount} />
        <bufferAttribute attach={"attributes-angle"} array={angleRef.current} itemSize={1} count={particleCount} />
      </bufferGeometry>
